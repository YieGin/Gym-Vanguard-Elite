  ...
  return (
    <div className="font-bold flex w-full justify-center flex-col px-4">
      <div className="ml-5 mt-10 mb-3 flex flex-col gap-y-1">
        <h1 className="text-[#181818] font-bold text-[25px]">Stringers</h1>
        <Link to="/Stringers">
