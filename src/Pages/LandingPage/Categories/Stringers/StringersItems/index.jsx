...
const StringersItems = ({ secondFiveIds }) => {
  ...
  const paddedsecondFiveIds = [
    ...secondFiveIds,
    ...new Array(5 - secondFiveIds.length).fill(null),
  ];

  return (
    <div className="flex TabletSm:gap-x-14 Tablet:gap-x-20">
      {paddedsecondFiveIds.map((item, index) => {
