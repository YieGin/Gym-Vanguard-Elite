      ...
      <div className="TabletSm:px-8 Tablet:px-[112px] PC:px-[360px]">
        <div className="flex SmartphonesSm:flex-wrap SmartphonesSm:gap-y-6 TabletSm:flex-nowrap gap-x-8 mt-5">
          <p className="font-Roboto w-full text-sm text-[#D7D7D7]">
            Copyright © 2000 - 2023 by COMPANY NAME
          </p>
        ...
        <p className="font-Roboto text-[#D7D7D7] text-sm mt-2">
          At LOVENSE, we are dedicated to providing a safe and responsible
          online environment for adults. We take our responsibility seriously
          and comply with all relevant regulations and guidelines. All models
          featured on our website are 18 years or older. By accessing and using
          our site, you confirm that you are at least 18 years old and
          understand and accept the content on our site, If you experience any
          Issues with our site, email our team at support@service.lovense.com.
        </p>
        <p className="font-Roboto text-[#D7D7D7] text-sm mt-4">
          For information on the Custadian of Records required, plesse refer to
          our U,S.C. 52257 Compliance Notice
        </p>
      </div>
    </div>
  );
