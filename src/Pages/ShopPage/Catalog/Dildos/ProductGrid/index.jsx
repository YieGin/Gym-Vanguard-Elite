...
import DildosData from "../../../../LandingPage/Categories/Dildos/DildosData";
...
const ProductGrid = ({
  ...
  const [productList, setProductList] = useState(DildosData);
  ...
  const sortProducts = (comparator) => {
    setProductList([...DildosData.sort(comparator)]);
  };
