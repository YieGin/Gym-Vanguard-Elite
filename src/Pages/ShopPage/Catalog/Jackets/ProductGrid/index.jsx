...
import JacketsData from "../../../../LandingPage/Categories/Jackets/JacketsData";
...
const ProductGrid = ({
  ...
  const [productList, setProductList] = useState(JacketsData);
  ...
  const sortProducts = (comparator) => {
    setProductList([...JacketsData.sort(comparator)]);
  };
