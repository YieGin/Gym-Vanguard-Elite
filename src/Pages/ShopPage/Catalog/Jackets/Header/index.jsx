    ...
    <div style={navbarStyle} className="sticky top-0 z-50">
      ...
      <div className="bg-[#ffffff] TabletSm:px-4 SmartphonesSm:px-[15px] Tablet:px-[32px] flex items-center justify-between border-[0.5px] SmartphonesSm:h-[44px] TabletSm:h-[80px] border-b-[#efefef]">
        ...
        <div className="flex gap-x-5">
          <input
            className="SmartphonesSm:hidden TabletSm:flex bg-[#FFFFFF] border-zinc-200 w-[312px] outline-none h-[40px] rounded-xl border-[1px] px-2 py-4 text-zinc-400 text-[13px] leading-4"
            type="text"
            placeholder="What are you looking for"
          />
          <button className="SmartphonesSm:hidden TabletSm:flex justify-center items-center bg-[#181818] w-[74px] h-[40px] rounded-xl text-[#fff] font-medium text-[14px] font-Roboto">
            Search
          </button>
        </div>
          ...
          <Link to="/Wishlist">
            <div className="flex cursor-pointer">
              <BiHeart
                ...
                color="#181818"
              />
              <div className="absolute SmartphonesSm:top-[60%] SmartphonesSm:right-[50px] TabletSm:right-[60px] TabletSm:top-[53%] Tablet:right-[77px] flex items-center justify-center SmartphonesSm:w-3 SmartphonesSm:h-3 TabletSm:w-4 TabletSm:h-4 bg-black rounded-full">
          ...
          <Link to="/Cart">
            <div className="flex cursor-pointer">
              <AiOutlineShoppingCart
                ...
                color="#181818"
              />
              <div className="absolute SmartphonesSm:top-[60%] SmartphonesSm:right-3 TabletSm:right-3 TabletSm:top-[53%] Tablet:right-7 flex items-center justify-center SmartphonesSm:w-3 SmartphonesSm:h-3 TabletSm:w-4 TabletSm:h-4 bg-black rounded-full">
