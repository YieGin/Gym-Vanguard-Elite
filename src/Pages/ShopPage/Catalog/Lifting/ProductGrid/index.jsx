...
import LiftingData from "../../../../LandingPage/Categories/Lifting/LiftingData";
...
const ProductGrid = ({
  ...
  const [productList, setProductList] = useState(LiftingData);
  ...
  const sortProducts = (comparator) => {
    setProductList([...LiftingData.sort(comparator)]);
  };
