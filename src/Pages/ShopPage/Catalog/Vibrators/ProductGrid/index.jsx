...
import VibratorsData from "../../../../LandingPage/Categories/Vibrators/VibratorsData";
...
const ProductGrid = ({
  ...
  const [productList, setProductList] = useState(VibratorsData);
  ...
  const sortProducts = (comparator) => {
    setProductList([...VibratorsData.sort(comparator)]);
  };
